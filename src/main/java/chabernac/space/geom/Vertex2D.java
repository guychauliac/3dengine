...
public class Vertex2D {
  ...
  public Vertex2D(Point2D aPoint, Point2D aTexturePoint, float anInverseDepth, float aDepth, float aLightning) {
    myPoint = aPoint;
  ...
  public static Vertex2D getInstance(Point2D aPoint, Point2D aTexturePoint, float aDepth, float aLightning) {
    ...
    result.myPerspectiveCorrectTexturePoint = new Point2D(aTexturePoint.x * result.myInverseDepth,
        aTexturePoint.y * result.myInverseDepth);
    return result;
  }
